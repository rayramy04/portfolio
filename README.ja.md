...
バニラHTML、CSS、JavaScriptで構築された、クリーンでレスポンシブなポートフォリオWebサイト。コンテンツ管理が簡単なデータ駆動型アーキテクチャ、レスポンシブデザイン、SEO最適化を特徴としています。開発便利のためのオプションHTML生成スクリプト付き。依存関係や複雑なビルドプロセスは不要です。
