...
window.cvData = {
    education: [
        {
            ...
            description: "GPA 4.0、主席表彰、奨学金獲得"
        },
        {
            institution: "Sunway College",
            degree: "Monash University Foundation Year (MUFY)",
            period: "2023.07 - 2024.06",
            description: "GPA 4.0（WAM93.25%）、成績優秀表彰、奨学金獲得"
        },
        {
            institution: "公立高等学校（国際バカロレア認定校）",
            degree: "普通科",
    ...
    experience: [
        {
            ...
            description: "留学関係のイベント登壇・運営、メディア露出、記事執筆",
        ...
        },
        {
            ...
            position: "インターンシップ",
            description: "留学関係の記事執筆、WordPressウェブサイトの構築、SEO対策",
        ...
        },
        {
            ...
            position: "インターンシップ",
            description: "AIを用いた業務自動化、JavaScriptフレームワークを用いたウェブサイト制作など",
            url: "https://www.tobiratory.com/"
        },
        {
            company: "[REDACTED]",
            period: "2024.06 - 2024.08",
            position: "インターンシップ（[REDACTED]）",
            description: "留学関係のイベント登壇・運営、通訳",
            url: "[REDACTED]"
        },
        {
            company: "株式会社ココナラ",
            ...
            position: "フリーランス",
            description: "音楽講師、オーダーメイド楽譜の制作、編曲",
        ...
        },
        {
            ...
            position: "インターンシップ",
            description: "留学関係の記事執筆、SEO対策",
            url: "https://loopal.net/"
        },
        {
            company: "一般社団法人52Hz",
            period: "2023.04 - Present",
            position: "会員、業務委託（52Hz Accelerator 0期メンター）",
            description: "中高生向け進路探求プログラムの運営、課外活動のメンター",
            ...
            skills: [
                {
                    ...
                    description: [
                        ...
                        "モナッシュ大学で数学分野における主席表彰",
                        "日本人工知能オリンピック金賞・日本5位",
                        "カンガルー数学コンテスト（世界最大の数学コンテスト）銀賞",
                        "東京大学 松尾研究室のAI講座を複数修了"
                    ]
                },
                {
                    ...
                    level: 5,
                    description: [
                        "ライターとして1ヶ月でGoogle AdSense審査合格、5か月で月1万PVを達成、累計700記事以上執筆",
                        "文章の論理構造や読みやすさに定評あり",
                        "複数の広告案件獲得",
                        "高校時代の研究論文コンテストで全国入賞多数"
                    ]
                },
                {
                    name: "Music",
                    ...
                    description: [
                        ...
                        "オンラインストアでのピアノ楽譜販売、オーダーメイド楽譜の制作",
                        "フリーランス音楽講師の経験"
                    ]
                },
                {
                    ...
                    description: [
                        "複数の業界でのインターンシップ経験",
                        "ウェブサイト運営や音楽事業を収益化",
                        "52Hz Acceleratorや家庭教師での中高生へのメンター経験",
                        "コミュニティ運営やサポート業務の担当経験"
                    ]
                }
            ]
        }
    ...
    certifications: [
        ...
        {
            title: "日本商工会議所 簿記検定試験 3級",
            organization: "日本商工会議所",
            date: "2025.02"
        },
        {
            title: "Mahout (象使い) 免許資格",
    ...
    awards: {
        "2025": [
            {
            title: "YouTube: チャンネル登録者数1万人達成",
            organization: "YouTube",
            date: "2025.06",
            description: "ピアノの演奏動画や制作した楽譜の動画を投稿",
            link: "https://www.youtube.com/@ray_pianocover"
            },
            {
            title: "日本人工知能オリンピック2025: 金賞、オープン枠 全国5位",
            organization: "国際人工知能オリンピック日本委員会",
            date: "2025.05",
            description: "Kaggle形式のデータ分析コンペティション",
            link: "https://ioai-japan.org/"
            },
            {
            title: "モナッシュ大学 情報学部: 成績優秀賞受賞",
            organization: "Monash University Malaysia",
            date: "2025.04",
            description: "全科目総合での成績優秀賞を受賞。WAM約90%"
            },
            {
            title: "モナッシュ大学 情報学部: 数学分野 主席表彰受賞",
            organization: "Monash University Malaysia",
            date: "2025.04",
            description: "数学分野における主席表彰を受賞"
            },
            {
            title: "東京大学AI経営講座 AI Business Insights 2025: 修了",
            organization: "東京大学 松尾研究室",
            date: "2025.04",
            description: "ビジネスにおけるAIの活用方法についての知見を深めた",
            link: "https://weblab.t.u-tokyo.ac.jp/lecture/course-list/ai-driven/"
            },
            {
                title: "日本言語学オリンピック2025: オープン枠 敢闘賞",
                organization: "国際言語学オリンピック日本委員会",
                date: "2025.02",
                description: "未知の言語を解析する学術オリンピック",
                link: "https://iolingjapan.org/"
            },
            {
            title: "20歳のつどい 同級生応援イベントにて、経歴掲載",
            organization: "地元市役所",
            date: "2025.01",
        ...
        "2024": [
            ...
            organization: "東京大学 松尾研究室",
            date: "2024.08",
            description: "データサイエンスの基礎やPythonでの機械学習の実装について学んだ",
            link: "https://gci2.t.u-tokyo.ac.jp/"
            },
            {
            title: "カンガルー数学コンテスト2024: 銀賞（Student Categories）",
            organization: "Kangaroo Math Malaysia",
            date: "2024.09",
            description: "世界最大の数学コンテスト",
            link: "https://www.kangaroomath.com.my/"
            },
            {
            title: "言語学オリンピック マレーシア大会 2024: 銅賞、ベスト32（Secondary Categories）",
            organization: "Malaysian Computational Thinking Association",
            date: "2024.03",
            description: "マレーシア国内でベスト32の成績を収め、決勝トーナメントにも進出",
            link: "https://myclo.my/"
            },
            {
            title: "日本言語学オリンピック2024: オープン枠 敢闘賞",
            organization: "国際言語学オリンピック日本委員会",
            date: "2024.02",
            description: "未知の言語を解析する学術オリンピック",
            link: "https://iolingjapan.org/"
        ...
        "~2023": [
            {
            title: "研究科学コンテスト: 全国最優秀賞、全国努力賞、国際大会出場 ほか",
            organization: "NA",
            date: "~2023",
            description: "合成音声（Text-to-Speech）の品質改善に関する、音響音声学領域の研究を行った"
            },
            {
            title: "名大MIRAI GSC: 第2ステージ 修了",
            organization: "名古屋大学",
            date: "~2023",
            description: "大学の研究室と共同で超伝導に関する研究を行った",
            link: "https://nuqa.nagoya-u.ac.jp/miraigsc/"
            },
            {
            title: "毎パソ冬季大会: 和文B 初段認定・高校生部門全国3位 ほか",
            organization: "毎日新聞社 ほか",
            date: "~2023",
            description: "タイピング技能で初段認定を受け、高校生部門で全国3位の成績を収めた",
            link: "https://pasoken.or.jp/maipaso/"
            },
            {
            title: "将棋: 県大会 優勝（団体）・第3位（個人）、東日本大会出場 ほか",
            organization: "県高等学校文化連盟 ほか",
            date: "~2023",
            description: "中学校から高校にかけて、将棋の大会に出場した"
            },
            {
            title: "英語ディベート: 県大会 ベストディベーター賞（個人）・第3位（団体）",
            organization: "県高等学校教育研究会",
            date: "~2023",
            description: "4人チームで参加し、自身はアタッカーの役割を務めた"
            }
        ]
    },
    grants: [
