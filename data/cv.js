...
window.cvData = {
    education: [
        ...
        },
        {
            ...
            description: {
                ...
                ja: "GPA 4.0（WAM 93.25%）・成績優秀表彰・奨学金獲得"
            }
        },
        {
            institution: {
    ...
    experience: [
        ...
        },
        {
            ...
            description: {
                en: "Study abroad article writing, WordPress site development, SEO optimization",
                ja: "留学関係記事執筆・WordPressサイト構築・SEO対策"
            },
        ...
        },
        {
            ...
            description: {
                en: "AI business automation, website development with JavaScript",
                ja: "AI業務自動化・JavaScriptでのウェブサイト制作"
            },
        ...
        },
        {
            ...
            description: {
                en: "Music instructor, custom sheet music transcription, music arrangement",
        ...
        },
        {
            ...
            description: {
                en: "Study abroad article writing, SEO optimization",
                ja: "留学関係記事執筆・SEO対策"
            },
    ...
    awards: {
        ...
        "~2023": [
            ...
            description: {
                ...
                ja: "合成音声（Text-to-Speech）の品質改善研究（音響音声学領域）"
            }
            },
            {
            title: {
