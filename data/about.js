...
window.aboutData = {
    personal: {
        ...
        description: [
            ...
            "マレーシアに渡航後は大学でトップクラスの成績を維持し、給付型奨学金を受給。人工知能オリンピックや言語学オリンピックなどでも入賞。",
    ...
    story: {
        ...
        paragraphs: [
            "高校生の頃、音響音声学の研究で初めてPythonに触れたことがきっかけで、AIや統計学への興味を深めました。また、自身が制作した学園祭のウェブサイトを全校生徒に利用してもらったことで、技術で人の役に立つ喜びを実感しました。",
            "その後、英語を使って最先端の技術を学びたいと考え、コンピュータサイエンスとデータサイエンスの両方を学べるモナッシュ大学マレーシア校に進学しました。現在は機械学習モデルの実装やWebアプリケーション開発を通じて、理論と実践の橋渡しに取り組んでいます。",
            "将来は、留学を通じて得たグローバルな視点や多様な課外活動の経験を活かし、技術で社会問題を解決するプロダクトを開発したいです。"
        ]
    },
    ...
    strengths: [
        ...
        },
        {
            ...
            description: "ゼロから価値を生み出し、実際にユーザーに届ける実行力",
            icon: "fas fa-rocket",
            highlights: [
