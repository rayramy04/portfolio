window.aboutData = {
  personal: {
    ...
    description: "2004年生まれ。高校時代は音響音声学の研究、将棋、英語ディベートをはじめとした課外活動に励み、全国大会で最優秀賞・努力賞を受賞し、国際大会にも出場。<br><br>マレーシアに渡航後は大学でトップレベルの成績を維持し、表彰を受け給付型奨学金を受給。人工知能オリンピックや言語学オリンピックなどでも入賞。<br><br>加えて、留学情報サイトの立ち上げや音楽フリーランスとしての活動も行いながら、インターンシップや海外旅行、格闘技にも取り組むなど、常に新たな挑戦を続けている。"
  },

  story: {
    paragraphs: [
      "高校生の頃、音響音声学の研究をしていた際に初めてPythonに触れ、それがきっかけでAIや統計学への興味を深めました。同時に、学園祭のウェブサイトを自分で作成したことで、自分が作ったサービスを他の人に使ってもらえる喜びを実感しました。",
      "その後、英語を使って最先端の技術を学びたいという強い思いから、コンピュータサイエンスとデータサイエンスの両方を学べるモナッシュ大学マレーシア校に進学しました。現在は理論と実践の両方を学びながら、特にAIやデータ解析の分野に取り組んでいます。",
  ...
  interests: [
    {
      title: "Programming",
      description: "PythonやJavaScriptを使った開発、機械学習の実装、ウェブサイト制作。",
      icon: "fas fa-code"
    },
    {
      title: "Music",
